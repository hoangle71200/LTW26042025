...
export class ProductGroup   {
  ...
  constructor(id: number, name: string, description: string, status: string, timeCreated: string, timeUpdated: string, image: string, note: string, productType: ProductType) {
    this._id = id
    this._name = name
